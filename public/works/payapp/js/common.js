$(function(){
    ...
    $(document).ready(function(){
        ...
        $(".main-visual .visual").css("height", currentHeight-topBannerHeight);   // visual-motion 섹션에 현재 높이값 반영
    });
    ...
    $('.service-nav').each(function(){
       var dotNum = $(this).find("ul li").length;
    ...
    // ask
    /* sj Start */
    $(".noti-box .view-btn").on('click', function () {
        $('.noti-box .reply').toggleClass('active');
        $(".noti-box .view-btn").toggleClass('active');
    });
    /* sj End */
